...
const Footer = () => {
  return (
    <footer className="bg-blue-over text-white border-t border-accent-2 dark:border-accent-2-dark">
      <Container>
        <div className="lg:py-12 flex flex-col lg:flex-row items-center">
            ...
            <div className="flex flex-row lg:flex-col text-center lg:text-left">
              <a href="https://twitter.com/B58Wallet" target="_blank" className="hover:text-blue-light sm:p-6 lg:p-0">
                <svg role="img" className="fill-current inline-block h-12 w-12" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                  <title>B58 Finance Twitter</title>
              ...
              <a href="https://discord.gg/AaqPTSdrhu" target="_blank" className="hover:text-blue-light sm:p-6 lg:p-0">
                <svg role="img" className="fill-current inline-block h-12 w-12" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
                  <title>B58 Finance Discord</title>
          ...
          <div className="flex flex-grow justify-end items-center lg:pl-4 lg:w-1/2">
            <div className="flex flex-col lg:items-end lg:mr-10">
              <a href="#" role="button" className="border-2 border-blue-medium bg-blue-medium hover:border-white hover:shadow-lg hover:bg-white hover:text-blue-light text-sm text-white uppercase font-bold py-4 px-6 rounded-md">
