...
const Navigation = () => {
  ...
  return (
    <nav className={ navbar 
      ? "dark:bg-blue-dark bg-white bg-opacity-75 dark:bg-opacity-75 sticky top-0 z-50 backdrop-filter firefox:bg-opacity-95 transition easy-in-out duration-200"
      : "dark:bg-blue-dark bg-white lg:bg-transparent sticky top-0 z-50 transition easy-in-out duration-200"
      }>
      <div className="flex flex-wrap container px-5 p-2 lg:p-6 mx-auto flex items-center justify-between">
        <div className="flex items-center flex-shrink-0 text-white lg:mr-8 lg:pr-8 lg:px-6">
          <a href="#home" title="Home" onClick={() => navbarOpen ? setNavbarOpen(false) : false} className="light:hidden">
            <img src="/images/logo.svg" alt="B58 Finance Logo" className={ navbar ? "h-6 md:h-8 float-left transition duration-500 transform" : "pt-1 h-8 md:h-12 float-left transition duration-500 transform"} />
          </a>
          <a href="#home" title="Home" onClick={() => navbarOpen ? setNavbarOpen(false) : false} className="dark:hidden">
            <img src="/images/logo_black.svg" alt="B58 Finance Logo" className={ navbar ? "h-6 md:h-8 float-left transition duration-500 transform" : "pt-1 h-8 md:h-12 float-left transition duration-500 transform"} />
          </a>
        </div>
